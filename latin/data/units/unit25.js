registerUnit({
  ...
  grammar: [
    {
      heading: "«Dīcit Titum vīvere» — how Latin says ‘that’",
      body: "<p>English reports speech with a little hinge-word: he says <em>that</em> Titus is alive. Classical Latin has no hinge-word at all. After a verb of saying, thinking, knowing, or perceiving, the reported sentence folds itself into a new shape: its subject turns <strong>accusative</strong>, its verb turns <strong>infinitive</strong>. <span class=\"la\">Nūntius dīcit Titum vīvere</span> — literally ‘the messenger says Titus to-be-alive’, that is, <em>the messenger says that Titus is alive</em>.</p><p>This is the famous <strong>accusative + infinitive</strong>, and Romans used it constantly — every letter, every rumor, every scrap of news in this unit arrives wrapped in it. The reading strategy: when you meet a ‘head’ verb like <span class=\"la\">dīcit</span>, <span class=\"la\">putat</span>, <span class=\"la\">scit</span>, <span class=\"la\">audit</span>, expect an accusative right after it, hold that accusative in mind as the subject of an infinitive still to come — and supply the word ‘that’ yourself.</p>",
      table: {
        caption: "Verbs that launch an indirect statement",
        headers: ["Verb", "Meaning", "Example"],
        rows: [
          ["dīcō", "say", "dīcit Titum vīvere — he says that Titus is alive"],
          ...
          ["crēdō", "believe", "crēdō Titum vīvere — I believe that Titus is alive"],
    ...
    },
    {
      ...
      body: "<p>Reported speech has to keep track of who is talking about whom, and Latin does it with one tiny word: <span class=\"la\">sē</span>. Inside an indirect statement, <span class=\"la\">sē</span> always points back to the reporter. <span class=\"la\">Titus scrībit sē valēre</span> — Titus writes that <em>he himself</em> is well. Swap in <span class=\"la\">eum</span> and the ‘he’ becomes somebody else: <span class=\"la\">Titus scrībit eum valēre</span> — Titus writes that <em>he</em> (some other man) is well.</p><p><span class=\"la\">mē</span>, <span class=\"la\">tē</span>, <span class=\"la\">nōs</span> and <span class=\"la\">vōs</span> behave just as you would hope: <span class=\"la\">sciō mē domī esse</span> — I know that I am home; <span class=\"la\">semper affirmābam tē vīvere</span> — I always declared that you were alive.</p><p>One more wrinkle. Because the report’s subject is accusative, a report can hold <strong>two accusatives</strong> at once — one the subject, one the object. <span class=\"la\">Sciō deōs mē servāvisse</span> — I know that the gods saved me: <span class=\"la\">deōs</span> is the subject of <span class=\"la\">servāvisse</span>, and <span class=\"la\">mē</span> is its object. The accusative that comes first is usually the subject; when in doubt, let sense and context decide — the gods saved me, not the other way round.</p>",
      table: {
        caption: "Pronoun subjects inside the indirect statement",
        headers: ["Latin", "Refers to", "Example"],
        rows: [
          ["sē", "the reporter himself/herself", "Titus dīcit sē valēre — Titus says that he (Titus) is well"],
          ["eum / eam / eōs", "somebody else", "Titus dīcit eum valēre — Titus says that he (another man) is well"],
    ...
    },
    {
      ...
      body: "<p>Two idioms round out the toolkit. First: to report a negative, Romans preferred one crisp verb, <span class=\"la\">negō</span> — ‘say that … not’. <span class=\"la\">Nauta negat Titum mortuum esse</span> — the sailor says that Titus is NOT dead. When you see <span class=\"la\">negō</span>, build the ‘not’ into the reported clause yourself.</p><p>Second: because the perfect passive and future infinitives contain a participle, that participle <strong>agrees</strong> with the accusative subject, like any adjective: <span class=\"la\">dīcit Titum reditūrum esse</span>, but <span class=\"la\">dīcit nāvem āmissam esse</span> and <span class=\"la\">nautās servātōs esse</span>. Those endings are old friends from units 22–23 — let them show you which accusative belongs to which infinitive. Verbs of hoping and promising (<span class=\"la\">spērō</span>, <span class=\"la\">prōmittō</span>) usually take the future infinitive: <span class=\"la\">prōmittit sē ventūrum esse</span> — he promises that he will come.</p>",
  ...
  vocab: [
    {
      ...
      pos: "verb (3rd conj.)",
      gloss: "live, be alive",
      example: "Nūntius dīcit Titum vīvere!",
      exampleGloss: "The messenger says that Titus is alive!"
    },
    {
      latin: "putō",
      ...
      pos: "verb (1st conj.)",
      gloss: "think, suppose",
      example: "Mārcus putat nāvem mox ventūram esse.",
      exampleGloss: "Marcus thinks that the ship will come soon."
    },
    {
      latin: "intellegō",
      ...
      pos: "verb (3rd conj.)",
      gloss: "understand",
      example: "Paulla intellegit mātrem trīstem esse.",
      exampleGloss: "Paulla understands that her mother is sad."
    },
    {
      latin: "affirmō",
      ...
      example: "Nauta affirmat sē Titum vīdisse.",
      exampleGloss: "The sailor asserts that he saw Titus."
    },
    {
      latin: "valeō",
      forms: "valēre, valuī",
      ...
      example: "Titus scrībit sē bene valēre.",
      exampleGloss: "Titus writes that he is well."
    },
    {
      latin: "celebrō",
      ...
      pos: "verb (1st conj.)",
      gloss: "celebrate",
      example: "Familia reditum Titī convīviō celebrat.",
      exampleGloss: "The family celebrates Titus’s return with a feast."
    },
    {
      latin: "amplector",
      ...
      gloss: "embrace",
      example: "Līvia frātrem lacrimāns amplectitur.",
      exampleGloss: "Livia, weeping, embraces her brother."
    },
    {
      latin: "testis",
      forms: "testis, m./f.",
      pos: "noun (3rd decl.)",
      gloss: "witness",
      example: "Testis affirmat sē Titum in īnsulā vīdisse.",
      exampleGloss: "The witness declares that he saw Titus on the island."
    },
    {
      latin: "mendācium",
      forms: "mendāciī, n.",
      pos: "noun (2nd decl.)",
      gloss: "lie, falsehood",
      example: "Rūmōrēs dē morte Titī mendācia erant.",
      exampleGloss: "The rumors about Titus’s death were lies."
    },
    {
      latin: "laetitia",
      forms: "laetitiae, f.",
    ...
    },
    {
      ...
      pos: "noun (2nd decl.)",
      gloss: "kiss",
      example: "Paulla avunculō multa ōscula dat.",
      exampleGloss: "Paulla gives her uncle many kisses."
    },
    {
      latin: "reditus",
      forms: "reditūs, m.",
      pos: "noun (4th decl.)",
      gloss: "return",
      example: "Omnēs dē reditū Titī loquuntur.",
      exampleGloss: "Everyone is talking about Titus’s return."
    },
    {
      latin: "adventus",
      forms: "adventūs, m.",
      pos: "noun (4th decl.)",
      gloss: "arrival",
      example: "Adventus Titī omnēs dēlectat.",
      exampleGloss: "Titus’s arrival delights everyone."
    },
    {
      latin: "convīvium",
      forms: "convīviī, n.",
      ...
      example: "Līvia convīvium magnum parat.",
      exampleGloss: "Livia prepares a great feast."
    },
    {
      latin: "pōculum",
      forms: "pōculī, n.",
    ...
    },
    {
      ...
      pos: "adjective (1st/2nd decl.)",
      gloss: "false",
      example: "Rūmor dē morte Titī falsus erat.",
      exampleGloss: "The rumor about Titus’s death was false."
    },
    {
      latin: "sānus",
      forms: "‑a, ‑um",
      pos: "adjective (1st/2nd decl.)",
      gloss: "healthy, sound",
      example: "Titus sānus et incolumis est.",
      exampleGloss: "Titus is healthy and unharmed."
    },
    {
      latin: "beātus",
      forms: "‑a, ‑um",
      pos: "adjective (1st/2nd decl.)",
      gloss: "blessed, happy",
      example: "Nēmō beātior est quam Līvia.",
      exampleGloss: "No one is happier than Livia."
    },
    {
      latin: "quidem",
      forms: "(indēcl.)",
      ...
      example: "Ego quidem crēdō Titum vīvere.",
      exampleGloss: "I for my part believe that Titus is alive."
    },
    {
      latin: "vix",
      forms: "(indēcl.)",
      ...
      example: "Līvia verbīs nūntiī vix crēdit.",
      exampleGloss: "Livia scarcely believes the messenger’s words."
    },
    {
      latin: "vērē",
      forms: "(indēcl.)",
  ...
  readings: [
    {
      ...
      intro: "After the storm, Ostia runs on rumors — until a letter-carrier brings word in Titus’s own hand.",
      paragraphs: [
        "Post tempestātem multī rūmōrēs per viās Ostiae volābant. Aliī dīcēbant Titum vīvere; aliī putābant eum mortuum esse. Mox rūmōrēs novī volābant: aliī dīcēbant nāvem Titī mersam esse et omnēs nautās periisse; aliī autem affirmābant nāvem ad Sardiniam pervēnisse. Mercātor ignōtus in tabernā clāmābat sē scīre Titum mortuum esse. Sed nauta, quī nūper ex Sardiniā vēnerat, negābat: «Mendācium est! Affirmō eum vīvere!»",
        "Līvia, hīs rūmōribus audītīs, vix dormīre poterat. «Alter dīcit frātrem meum vīvere», inquit, «alter putat eum mortuum esse. Rūmōribus crēdere nōn possum.» Quīntus autem semper affirmābat avunculum suum vīvere; crēdēbat enim Titum gubernātōrem optimum esse.",
        "Subitō Ferōx lātrāvit: tabellārius epistulam portābat! Mārcus epistulam celeriter lēgit; deinde magnā vōce clāmāvit: «Titus haec verba suā manū scrīpsit! Scrībit sē vīvere et bene valēre. Dīcit nāvem quidem āmissam esse, sed nautās servātōs esse. Affirmat sē mox domum reditūrum esse!» Tum Līvia lacrimāre incēpit — nōn dolōre, sed laetitiā. Omnēs enim intellēxērunt rūmōrēs falsōs fuisse."
      ],
      glosses: {
        "post": "after (+ acc.)",
        ...
        "titum": "Titus (acc. — subject of the infinitive)",
        "mortuum": "dead (agrees with «Titum»/«eum»)",
        "sed": "but",
        "nauta": "a sailor",
        "quī": "who",
        "nūper": "recently",
        ...
        "enim": "for, you see",
        "gubernātōrem": "helmsman, pilot (acc.)",
      ...
      translation: [
        "After the storm many rumors were flying through the streets of Ostia. Some kept saying that Titus was alive; others thought that he was dead. Soon new rumors were flying: some kept saying that Titus’s ship had been sunk and that all the sailors had perished; others, however, declared that the ship had reached Sardinia. An unknown merchant kept shouting in a tavern that he knew Titus was dead. But a sailor, who had recently come from Sardinia, said no: «It is a lie! I declare that he is alive!»",
        "Livia, when these rumors had been heard, could scarcely sleep. «One man says that my brother is alive,» she said, «another thinks that he is dead. I cannot trust rumors.» But Quintus always kept declaring that his uncle was alive; for he believed that Titus was the best helmsman.",
        "Suddenly Ferox barked: a letter-carrier was bringing a letter! Marcus read the letter quickly; then he shouted in a loud voice: «Titus wrote these words with his own hand! He writes that he is alive and well. He says that the ship, it is true, was lost, but that the sailors were saved. He declares that he will soon return home!» Then Livia began to weep — not from grief, but from joy. For they all understood that the rumors had been false."
      ],
      questions: [
        {
          q: "What were the rumors flying around Ostia after the storm?",
          options: [
            "Everyone agreed that Titus had drowned",
            ...
            "Titus had decided to stay in Greece"
          ],
          answer: 1,
          explain: "«Aliī dīcēbant nāvem Titī mersam esse et omnēs nautās periisse; aliī affirmābant nāvem ad Sardiniam pervēnisse» — two reports, both wrapped in the accusative + infinitive."
        },
        {
          q: "In «Affirmō eum vīvere», what is the sailor claiming?",
          options: [
            "That he orders Titus to live",
            "That Titus used to live in Ostia",
            "That he himself (the sailor) is alive",
            "That Titus is alive — accusative «eum» + infinitive «vīvere» after a verb of declaring"
          ],
          answer: 3,
          explain: "«affirmō» launches an indirect statement: «eum» (= Titus) is the accusative subject, «vīvere» the present infinitive — ‘I declare that he is alive.’ For himself the sailor would say «sē vīvere»."
        },
        {
          q: "According to Titus’s letter, what happened to the ship and the crew?",
          options: [
        ...
        {
          q: "Why does Livia begin to weep at the end of the reading?",
          options: [
            "Because the letter confirms Titus’s death",
            "Because Ferox has been barking all day",
    ...
    },
    {
      ...
      paragraphs: [
        "Paucīs post diēbus Quīntus, quī cotīdiē in portū sedēbat nāvēsque spectābat, procul vēlum cōnspexit. «Nāvis venit!» clāmāvit. «Putō eam ex Sardiniā venīre!» Tōta familia ad portum cucurrit; etiam Ferōx, quī omnēs sequēbātur, magnā laetitiā lātrābat.",
        "Nāvis lentē appropinquābat, et Paulla prīma Titum cōnspexit. «Videō avunculum in nāve stāre!» clāmāvit. Vērē dīxerat: mox Titus in terrā stābat, sānus et incolumis, sed barba eius longa erat. Līvia frātrem lacrimāns amplexa est; Paulla eī multa ōscula dedit; Mārcus Quīntusque eum quoque amplexī sunt. «Semper affirmābam tē vīvere!» inquit Quīntus. Titus rīsit: «Bene putābās, mī Quīnte. Vix crēdō mē vīvum esse — sed ecce, vīvō!»",
        "Vesperī familia reditum Titī convīviō magnō celebrābat. Mēnsa cibō optimō plēna erat, pōcula vīnō plēna; omnēs ūnā cēnābant et carmina laeta cantābant. Titus multa dē naufragiō nārrāvit. Dīxit tempestātem maximam subitō factam esse; affirmāvit nāvem prope Sardiniam ad saxa iactātam et frāctam esse, sed sē cum nautīs in terram natāvisse. «Sciō deōs mē servāvisse», inquit; «eīs grātiās agō.» Affirmāvit sē novam nāvem parātūrum esse. «Putāsne mē mare timēre? Minimē! Prōmittō Quīntum mēcum ōlim nāvigātūrum esse!» Quīntus, hīs verbīs audītīs, beātissimus erat.",
        "Subitō clāmor: Ferōx botulum ē mēnsā rapuerat et sub lectō dēvorābat! Omnēs rīsērunt. «Nunc vērē sciō mē domī esse», inquit Titus. Familia iterum ūnā beāta erat; Līvia illā nocte deīs grātiās ēgit, quod frātrem suum vīvere sciēbat."
      ],
      glosses: {
        ...
        "mī": "my (voc. — «mī Quīnte» = my dear Quintus)",
        ...
        "sē": "that he himself (acc. — points back to the speaker, Titus)",
        "cum": "with",
        ...
        "quīntum": "Quintus (acc. — subject of the infinitive)",
        "mēcum": "with me («cum» attached to «mē»)",
        "ōlim": "one day (here, of the future)",
        "nāvigātūrum": "going to sail; «nāvigātūrum esse» = will sail (future infinitive)",
      ...
      translation: [
        "A few days later Quintus, who sat in the harbor every day and watched the ships, caught sight of a sail far off. «A ship is coming!» he shouted. «I think it is coming from Sardinia!» The whole family ran to the harbor; even Ferox, who followed them all, was barking with great joy.",
        "The ship slowly drew near, and Paulla was the first to catch sight of Titus. «I see uncle standing on the ship!» she shouted. She had spoken truly: soon Titus was standing on land, healthy and unharmed, though his beard was long. Livia, weeping, embraced her brother; Paulla gave him many kisses; Marcus and Quintus embraced him too. «I always declared that you were alive!» said Quintus. Titus laughed: «You thought well, my dear Quintus. I scarcely believe that I am alive myself — but look, I live!»",
        "In the evening the family celebrated Titus’s return with a great feast. The table was full of excellent food, the cups full of wine; everyone dined together and sang joyful songs. Titus told many things about the shipwreck. He said that a huge storm had suddenly arisen; he declared that the ship had been hurled onto rocks near Sardinia and wrecked, but that he and his sailors had swum to land. «I know that the gods saved me,» he said; «I give them thanks.» He declared that he would get a new ship ready. «Do you think that I fear the sea? Not at all! I promise that Quintus will one day sail with me!» When these words had been heard, Quintus was utterly happy.",
        "Suddenly an uproar: Ferox had snatched a sausage from the table and was devouring it under a couch! Everyone laughed. «Now I truly know that I am home,» said Titus. The family, together again, was happy; that night Livia gave thanks to the gods, because she knew that her brother was alive."
      ],
      questions: [
        {
          q: "Who is the first to catch sight of Titus himself on the arriving ship?",
          options: [
            "Quintus",
            "Paulla — «Paulla prīma Titum cōnspexit»",
            "Livia",
            "Ferox"
          ],
          answer: 1,
          explain: "Quintus spots the sail («vēlum cōnspexit»), but it is Paulla who first sees the man: «Paulla prīma Titum cōnspexit»."
        },
        {
        ...
        {
          q: "What does Titus declare about his future plans?",
          options: [
            "He will get a new ship ready — and he promises that Quintus will one day sail with him",
            "He will never go to sea again",
            "He will move the family to Sardinia",
            "He will sell his ship and become a grain merchant"
          ],
          answer: 0,
          explain: "«Affirmāvit sē novam nāvem parātūrum esse … Prōmittō Quīntum mēcum ōlim nāvigātūrum esse» — two future infinitives in ‑ūrum esse."
        },
        {
          q: "What does Ferox do during the feast?",
          options: [
          ...
          answer: 2,
          explain: "«Ferōx botulum ē mēnsā rapuerat et sub lectō dēvorābat» — the pluperfect «rapuerat»: by the time anyone shouted, the theft was already history. Some things never change."
        }
      ]
    }
  ],
  ...
  quiz: [
    {
      prompt: "In «Nūntius dīcit Titum vīvere», what is being said?",
      options: [
        "The messenger tells Titus to live",
        "The messenger says that Titus is alive",
        "Titus says that the messenger is alive",
        "The messenger and Titus are both alive"
      ],
      answer: 1,
      explain: "After «dīcit», the accusative «Titum» is the subject of the infinitive «vīvere»: an indirect statement — ‘says THAT Titus is alive’."
    },
    {
      prompt: "Which sentence says «Livia thinks that the ship was lost»?",
      options: [
        "Līvia putat nāvem āmissam esse",
        "Līvia nāvem āmīsit",
        "Līvia dīcit sē nāvem āmīsisse",
        "Nauta putat Līviam āmissam esse"
      ],
      answer: 0,
      explain: "«putat» + accusative subject «nāvem» + perfect passive infinitive «āmissam esse» = ‘thinks that the ship was lost’. The others say Livia lost it herself, or that LIVIA was lost."
    },
    {
      prompt: "In «Nauta affirmat sē Titum vīdisse», when did the sailor see Titus?",
      options: [
      ...
      answer: 1,
      explain: "The ‑isse ending marks the perfect infinitive: time EARLIER than the main verb. «Affirmat sē Titum vīdisse» = he declares that he SAW Titus."
    },
    {
      prompt: "«Scrībit sē mox domum reditūrum esse.» What is Titus saying about his return?",
      options: [
    ...
    {
      prompt: "In «Titus dīcit sē valēre», who is well?",
      options: [
        "Titus himself — «sē» points back to the subject of the saying verb",
        "Somebody other than Titus",
        "The person Titus is talking to",
        "No one — «sē» makes the verb negative"
      ],
      answer: 0,
      explain: "Inside an indirect statement, «sē» refers to the reporter: Titus says that HE (Titus) is well. For another man, Latin would say «eum valēre»."
    },
    {
      prompt: "What does «Nauta negat Titum mortuum esse» mean?",
      options: [
        "The sailor asks whether Titus is dead",
        "The sailor says that Titus is dead",
        "The sailor orders Titus not to die",
        "The sailor says that Titus is NOT dead — «negō» = ‘say that…not’"
      ],
      answer: 3,
      explain: "Latin prefers one verb, «negō», where English says ‘say that…not’. So «negat Titum mortuum esse» = he denies that Titus is dead."
    },
    {
