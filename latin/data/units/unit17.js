registerUnit({
  ...
  vocab: [
    ...
    },
    {
      ...
      pos: "adjective (3rd decl.)",
      gloss: "sweet",
      example: "Māla dulcia Paullam dēlectant.",
      exampleGloss: "Sweet apples delight Paulla."
    },
    {
      latin: "gravis",
      forms: "-e",
    ...
    },
    {
      ...
      pos: "adjective (3rd decl., one ending)",
      gloss: "bold, daring",
      example: "Paulla audāx est: leōnēs nōn timet.",
      exampleGloss: "Paulla is bold: she is not afraid of lions."
    },
    {
      latin: "ferōx",
      forms: "(gen. ferōcis)",
      pos: "adjective (3rd decl., one ending)",
      gloss: "fierce, wild",
      example: "Ferōx nōn semper ferōx est: saepe dormit.",
      exampleGloss: "Ferox is not always ferocious: he often sleeps."
    },
    {
      latin: "quam",
      forms: "(indēcl.)",
    ...
    },
    {
      ...
      example: "Quīntus nōn est tam audāx quam soror.",
      exampleGloss: "Quintus is not as bold as his sister."
    },
    {
      latin: "leō",
      forms: "leōnis, m.",
    ...
    },
    {
      ...
      gloss: "contest, race",
      example: "Certāmina quadrīgārum Quīntum dēlectant.",
      exampleGloss: "The chariot races delight Quintus."
    },
    {
      latin: "vincō",
  ...
  readings: [
    {
      ...
      intro: "Titus takes the family to the chariot races — along with, it seems, every other person in Rome.",
      paragraphs: [
        "Hodiē familia Fabia laetissima est: Titus enim omnēs ad Circum Maximum dūcit. Ibi certāmina quadrīgārum sunt. In circō turba ingēns sedet; clāmor cīvium maximus est. «Ecce!» inquit Titus. «Hic circus maximus omnium aedificiōrum urbis est.»",
        "Subitō quadrīgae in harēnam veniunt. Hic aurīga tunicam albam habet, ille rūfam. Equī celeriter currunt — quam celerēs sunt! Aurīga albus celer est, sed aurīga rūfus celerior. Quīntus stat et clāmat: «Curre, curre! Vince!»",
        "Tandem aurīga rūfus omnēs superat: victor est! Turba gaudet et victōrem laudat. «Victōria dulcis est!» inquit Titus. «Aurīga rūfus fēlīx erat — et audāx. Aurīgae enim audācēs saepe vincunt.» Paulla rīdet: «Ego quoque aurīga esse cupiō! Sum enim audācior quam Quīntus!»"
      ],
      glosses: {
        "hodiē": "today",
        "familia": "the family",
      ...
      translation: [
        "Today the Fabius family is overjoyed: Titus is taking everyone to the Circus Maximus. The chariot races are there. In the circus an enormous crowd is sitting; the roar of the citizens is tremendous. «Look!» says Titus. «This circus is the greatest of all the buildings of the city.»",
        "Suddenly the chariot teams come onto the track. This charioteer wears a white tunic, that one a red. The horses run at speed — how fast they are! The charioteer in white is fast, but the charioteer in red is faster. Quintus stands and shouts: «Run, run! Win!»",
        "At last the charioteer in red overtakes them all: he is the winner! The crowd rejoices and praises the victor. «Victory is sweet!» says Titus. «The red charioteer was lucky — and bold. Bold charioteers, you see, often win.» Paulla laughs: «I want to be a charioteer too! After all, I am bolder than Quintus!»"
      ],
      questions: [
        {
          q: "Why is the family so happy at the start of the reading?",
          options: [
            "Titus is taking them all to the races at the Circus Maximus",
            "Ferox has finally learned to behave",
            "They are sailing home to Ostia today",
            "Marcus has sold all his grain at a good price"
          ],
          answer: 0,
          explain: "«Titus enim omnēs ad Circum Maximum dūcit» — Titus is leading everyone to the Circus, where the chariot races are held."
        },
        {
        ...
        {
          q: "What does Paulla claim at the end?",
          options: [
            "That she is bolder than Quintus and wants to be a charioteer herself",
            "That the charioteer in white really won",
            "That she is faster than the horses",
            "That chariot racing is boring"
          ],
          answer: 0,
          explain: "«Ego quoque aurīga esse cupiō! Sum enim audācior quam Quīntus!» — she wants to be a charioteer, being (she says) bolder than her brother."
        }
      ]
    },
    {
      title: "Fortior Quam Leō",
      intro: "Next stop, the amphitheater: gladiators, a very large lion — and Paulla, aged eight, with strong opinions.",
      paragraphs: [
        "Mox Titus familiam ad amphitheātrum dūcit. Aedificium est ingēns. «Estne amphitheātrum maius quam circus?» rogat Paulla. «Minimē,» respondet Titus, «circus maior est. Sed hoc aedificium pulchrius est quam omnia aedificia urbis.» Intrant et sedent; ubīque hominēs sunt.",
        "Tum gladiātōrēs in harēnam veniunt et fortiter pugnant. Omnēs fortēs sunt, sed hic gladiātor, vir ingēns, omnēs superat. Turba clāmat: «Fortissimus omnium est!» Quīntus stupet: «Gladiātōrēs fortiōrēs sunt quam mīlitēs!» «Fortasse,» inquit Mārcus et rīdet.",
        ...
        "Deinde familia ad caupōnam ambulat et dē spectāculō nārrat. «Gladiātor fortior erat quam leō!» inquit Paulla. «Ita,» respondet Quīntus, «sed leō nōn erat tam ferōx quam canis noster. Ferōx enim botulōs rapit — et numquam dormit!» Omnēs rīdent. «Vēra dīcis,» inquit Līvia. «Canis noster ferōcior est quam omnēs leōnēs Rōmae!»"
      ],
      glosses: {
        "mox": "soon, presently",
        ...
        "venit": "comes",
        "ferōx": "fierce; with a capital letter it is also the dog’s name — Ferox",
        "nunc": "now",
      ...
      translation: [
        "Soon Titus takes the family to the amphitheater. The building is enormous. «Is the amphitheater bigger than the circus?» asks Paulla. «Not at all,» Titus answers, «the circus is bigger. But this building is more beautiful than all the buildings of the city.» They go in and sit down; there are people everywhere.",
        "Then the gladiators come into the arena and fight bravely. All are strong, but this one gladiator, a huge man, defeats them all. The crowd shouts: «He is the strongest of them all!» Quintus is amazed: «Gladiators are braver than soldiers!» «Perhaps,» says Marcus, and smiles.",
        ...
        "Afterwards the family walks to the inn and talks about the show. «The gladiator was braver than the lion!» says Paulla. «Yes,» Quintus answers, «but the lion was not as fierce as our dog. Ferox, after all, steals sausages — and he never sleeps!» Everyone laughs. «You speak the truth,» says Livia. «Our dog is fiercer than all the lions of Rome!»"
      ],
      questions: [
        {
          q: "According to Titus, how does the amphitheater compare with the circus?",
          options: [
        ...
        {
          q: "What is Quintus’s point about Ferox at the inn?",
          options: [
            "Ferox is not nearly as fierce as the lion",
            "The lion was not as fierce as Ferox — the dog steals sausages and never sleeps",
            "Ferox would be terrified of the lion",
            "Ferox should be trained as a gladiator"
          ],
          answer: 1,
  ...
  quiz: [
    {
      prompt: "In «Quīntus celerior est quam Paulla», what does «quam» mean?",
      options: ["how", "than", "and", "very"],
      answer: 1,
      explain: "After a comparative in -ior, «quam» means ‘than’: Quintus is faster than Paulla. (His opinion, anyway.)"
    },
    {
    ...
    {
      prompt: "In «Paulla tam audāx est quam Quīntus», what is being claimed?",
      options: [
        "Paulla is bolder than Quintus",
        "Paulla is just as bold as Quintus",
        "Paulla is less bold than Quintus",
        "Quintus is the boldest person in Rome"
      ],
      answer: 1,
      explain: "«tam … quam» = ‘as … as’ — an equal match. For ‘bolder than’, Latin would use the comparative: «audācior quam Quīntus»."
    },
    {
